...
compose = Path(r"D:/n8n/docker-compose.yml")
t = compose.read_text(encoding="utf-8")
t = t.replace("WAHA_NO_API_KEY=True", "WAHA_NO_API_KEY=False")
t = re.sub(r"(-\s*WAHA_API_KEY=)\S*", r"\g<1>" + KEY, t, count=1)
if "WAHA_API_KEY=" not in t.split("  waha:")[0]:
    t = t.replace(
...
Path(r"D:/n8n/.waha_api_key").write_text(KEY, encoding="utf-8")
...
print("ok key_len", len(KEY))
print("no_api_key_false", "WAHA_NO_API_KEY=False" in compose.read_text(encoding="utf-8"))
